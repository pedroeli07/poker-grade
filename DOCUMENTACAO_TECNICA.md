...
### 8.1 Página: /dashboard/players (lista de jogadores)
...
### 8.2 Página: /dashboard/players/{id} (perfil do jogador)
...
### 8.4 Página: /dashboard/players (modal Novo Jogador)
...
Os nicks por rede de poker são adicionados manualmente pelo usuário na ficha individual (`/dashboard/players/[id]`) após o cadastro, usando o formulário "Adicionar nick" que exige nick + rede obrigatoriamente.

### 8.5 Nova página: /dashboard/sharkscope/alerts
...
### 8.6 Nova página: /dashboard/sharkscope/analytics
...
### 8.7 Nova página: /dashboard/sharkscope/scouting
...
|------|----------------|
| /dashboard/sharkscope/alerts | Admin, Manager, Coach |
| /dashboard/sharkscope/analytics | Admin, Manager, Coach |
| /dashboard/sharkscope/scouting | Admin, Manager |
...
4. Coluna "Performance 10d" na página `/dashboard/players`
5. Card de alertas no Dashboard principal
6. Página `/dashboard/sharkscope/alerts`
...
3. Página `/dashboard/sharkscope/analytics` (por site, tier, modalidade)
...
1. Página `/dashboard/sharkscope/scouting`
