...
const HistoryDeleteDialog = memo(function HistoryDeleteDialog({
  open,
  onOpenChange,
  count,
  disabled,
      ...
      <ADContent className={destructiveAlertDialogContentClassName}>
        ...
        <ADH className={destructiveAlertHeaderClassName}>
          <ADT className={destructiveAlertTitleClassName}>
            {isMultiple ? "Excluir registros do histórico?" : "Excluir registro do histórico?"}
          </ADT>
          <ADD asChild>
            <div className={destructiveAlertDescriptionWrapClassName}>
              <p>
                {isMultiple
                  ? `Você está prestes a excluir ${count} registros do histórico.`
                  : "O registro será removido permanentemente do histórico."}
              </p>
...
HistoryDeleteDialog.displayName = "HistoryDeleteDialog";
