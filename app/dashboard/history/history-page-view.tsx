...
import type { HistoryPageData } from "../../../hooks/history/history-page-load";

export function HistoryPageView({ history, upgrades, downgrades }: HistoryPageData) {
  return (
              ...
              {history.map((item) => {
                ...
                return (
                  <div key={item.id} className="relative flex gap-4 pb-5 last:pb-0">
                    <div
                      className={`relative z-10 flex items-center justify-center w-[34px] h-[34px] rounded-full border-2 shrink-0 bg-background ${item.action === "UPGRADE"
