...
/** Valor sentinela no filtro da coluna Grupo Shark: qualquer jogador com grupo preenchido. */
export const PLAYER_GROUP_FILTER_HAS_ANY = "__player_group_has_any__";
...
export const AUTH_INPUT_CLASS =
  "h-11 w-full rounded-xl border border-border bg-card/50 px-3.5 text-sm text-foreground outline-none placeholder:text-muted-foreground/50 focus-visible:border-primary/50 focus-visible:ring-2 focus-visible:ring-primary/20";
