...
export const SESSION_MAX_AGE_SEC = 60 * 60 * 24 * 3; // 3 days
// Renew session when less than this much time remains (1 day)
export const SESSION_RENEWAL_THRESHOLD_SEC = 60 * 60 * 24;
